...
class ProductsRepository implements ProductsInterface
{
    ...
    public function save(Request $request)
    {
        ...
        $newIngredients = json_decode($request->input('ingredients'),true);
        $ingredientIDs = [];
        foreach ($newIngredients as $ingredient) {
                $ingredient = Inventory::updateorcreate(['product_id',$product->id],['name' => $ingredient['name'], 'threshold' => $ingredient['threshold'], 'product_id' => $product->id]);
